...
from .views import user_register, user_login, acc_details, vendor_register, vendor_login, add_favourites, favourites_list

urlpatterns = [
    path('', user_register, name='register'),
    path('login/', user_login, name='login'),
    path('profile/', acc_details, name='profile'),
